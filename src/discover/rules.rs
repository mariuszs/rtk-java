...
pub const RULES: &[RtkRule] = &[
    ...
    RtkRule {
        pattern: r"^(?:\.\/?)?mvnw?\s+(?:\S+\s+)*(test|verify|compile|package|clean|install|integration-test|deploy|dependency:tree|checkstyle:check|checkstyle)\b",
        rtk_cmd: "rtk mvn",
    ...
    RtkRule {
        pattern: r"^mvnd\s+(?:\S+\s+)*(test|verify|compile|package|clean|install|integration-test|deploy|dependency:tree|checkstyle:check|checkstyle)\b",
        rtk_cmd: "rtk mvnd",
